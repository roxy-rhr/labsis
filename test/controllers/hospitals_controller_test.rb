...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { categoria: @hospital.categoria, ciudad: @hospital.ciudad, direccion: @hospital.direccion, logo: @hospital.logo, nombre: @hospital.nombre, provincia: @hospital.provincia, sigla: @hospital.sigla }
    end
  ...
  test "should update hospital" do
    patch :update, id: @hospital, hospital: { categoria: @hospital.categoria, ciudad: @hospital.ciudad, direccion: @hospital.direccion, logo: @hospital.logo, nombre: @hospital.nombre, provincia: @hospital.provincia, sigla: @hospital.sigla }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
